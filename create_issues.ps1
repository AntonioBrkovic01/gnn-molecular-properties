...
- [ ] Kratki opisi dataseta u markdown celijama"
...
- [ ] Spremanje najboljeg modela (torch.save)"
...
- [ ] Error handling za neispravne SMILES"
...
- [ ] Azuriranje README s finalnim uputama za pokretanje"
